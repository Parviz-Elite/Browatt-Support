    ...
    Route::middleware('role_or_permission:general_manager|settings.manage')->group(function () {
        Route::get('/settings', function (MehrsoftWarrantyService $warrantyService) {
            ...
            $smsDefaults = [
                ...
                'warranty_activation_enabled' => config('services.farazsms.warranty_activation.enabled', false),
                'warranty_activation_pattern_code' => config('services.farazsms.warranty_activation.pattern_code'),
                'warranty_activation_product_title_attribute' => config('services.farazsms.warranty_activation.product_title_attribute', 'ptitle'),
                'warranty_activation_product_serial_attribute' => config('services.farazsms.warranty_activation.product_serial_attribute', 'pserial'),
                'warranty_activation_expires_at_attribute' => config('services.farazsms.warranty_activation.expires_at_attribute', 'wdate'),
        ...
        Route::put('/settings/sms', function (Request $request) {
            $validated = $request->validate([
                ...
                'warranty_activation_enabled' => ['boolean'],
                'warranty_activation_pattern_code' => ['nullable', Rule::requiredIf($request->boolean('warranty_activation_enabled')), 'string', 'max:120'],
                'warranty_activation_product_title_attribute' => ['nullable', Rule::requiredIf($request->boolean('warranty_activation_enabled')), 'string', 'max:80'],
                'warranty_activation_product_serial_attribute' => ['nullable', Rule::requiredIf($request->boolean('warranty_activation_enabled')), 'string', 'max:80', 'different:warranty_activation_product_title_attribute'],
                'warranty_activation_expires_at_attribute' => ['nullable', Rule::requiredIf($request->boolean('warranty_activation_enabled')), 'string', 'max:80', 'different:warranty_activation_product_title_attribute,warranty_activation_product_serial_attribute'],
                ...
                'warranty_activation_enabled' => 'ارسال پیامک فعال‌سازی گارانتی',
                'warranty_activation_pattern_code' => 'کد پترن فعال‌سازی گارانتی',
                'warranty_activation_product_title_attribute' => 'نام متغیر عنوان محصول',
                'warranty_activation_product_serial_attribute' => 'نام متغیر سریال محصول',
                'warranty_activation_expires_at_attribute' => 'نام متغیر تاریخ اعتبار',
            ...
            AppSetting::query()->updateOrCreate(
                ...
                ['value' => [
                    ...
                    'warranty_activation_enabled' => (bool) ($validated['warranty_activation_enabled'] ?? false),
                    'warranty_activation_pattern_code' => $validated['warranty_activation_pattern_code'] ?? null,
                    'warranty_activation_product_title_attribute' => $validated['warranty_activation_product_title_attribute'] ?? 'ptitle',
                    'warranty_activation_product_serial_attribute' => $validated['warranty_activation_product_serial_attribute'] ?? 'pserial',
                    'warranty_activation_expires_at_attribute' => $validated['warranty_activation_expires_at_attribute'] ?? 'wdate',
